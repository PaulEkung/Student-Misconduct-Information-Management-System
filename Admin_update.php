...
Update student report <a href="Admin_Dashboard.php" class="btn btn-danger offset-7">Exit</a>
...
<textarea type="text" name='message' cols="80" rows="40" class="form-control textarea p-3"
     style="height:30vh"><?php echo $row['description'] ?></textarea>
